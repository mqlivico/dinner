...
<!-- 				<select id="select_cl" class="span3">
			...
			<!--	<div id="select_cl" class="dropdown span3">
				...
				<a href="javascript:;" id="set_money" class="btn_transparent right">餐费设置</a>
		...
		<div class="container">
			<ul class="row">
				...
				<a  id="membership_management_nav" class="span2">订餐</a>
				<a  id="index_nav" class="span2">统计</a>
				<a  id="router_admin_nav" class="span2">员工</a>
				<!-- <a  id="status_table_nav" class="span2">未完人员</a> -->
...
function dinner(){
	$.ajax({
		url:Q.url+"/html/model/dinner.jsp",
		dataType:'text',
...
$('#index_nav').die('click').live('click',function(){
	$.ajax({
		url:Q.url+"/html/model/statistic.jsp",
		dataType:'text',
		success:function(html){
			$("#content").attr("style","display:block;");
			$("#content").html(html);
...
$('#set_money').die('click').live('click',function(){
	$.ajax({
		url:Q.url+"/html/model/setmoney.jsp",
		dataType:'text',
		success:function(html){
			$("#content").attr("style","display:block;");
			$("#content").html(html);
