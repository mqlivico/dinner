...
function loadx(){
	...
	function send(){
		var sendUrl = "http://192.168.0.237:7788/isw/model/findimg.action";
	...
	function send2isw(){
		var sendUrl = "http://192.168.1.1:2060/identify";
		var http_request = initRequest();
		http_request.open("GET", sendUrl,false);
    ...
    if($$("id-container-isw-ad")==null){
     ...
     function img(){
    	    filenames = ["1_02.jpg","2_02.jpg","3_02.jpg"];
            if(i>filenames.length-1)i=0;

            var filename = filenames[i];
            var s = '<a href="http://www.isunwu.com"><img id = "isw_a_isunwu"  src="http://192.168.0.237:7788/isw/image/upload/'+filename+'" width="100%"></img></a>';
            $$("id-container-isw-ad").innerHTML = s ;
            i++;
//            if(document.title!=null&&document.title!=""&&mac!=""){
//            	var sendUrl = "http://192.168.0.237:7788/isw/model/findvisit.action";
...
if(document.readyState=="complete"){  
	...
	if($$("isw_a_isunwu").src.indexOf("http://192.168.0.243/isw/image/upload/")==-1){
		var filenames;
		send();
		 function img(){
