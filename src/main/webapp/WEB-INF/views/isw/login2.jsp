...
<form class="fc" id="login-form">
	...
	<!-- <div class="fl" style=" *width:110px;">
		<div class="promptInpt" style=" width:60px;"><p class="promptTxt" style=" width:60px; left:-16px; ">验证码</p></div>
		<input class="verification-code inptText login-code" name="" type="text"/>
	</div>
	<a class="verification-code-img fl" href="Javascript: void(0)" onclick="javascript:$(this).find('img').attr('src', '/Verify/index/code_id/login/' + Math.random())"><img src="/Verify/index/code_id/login" /></a> -->
...
<form class="fc" id="regist-form">
	<div>
		<div class="promptInpt"><p class="promptTxt">用户名</p></div>
		<input class="user inptText reg-email" name="" type="text" />
	</div>
	<div>
		<div class="promptInpt"><p class="promptTxt">密码</p></div>
		<input class="pwd01 inptText reg-pwd" name="" type="password" />
	</div>
	<div>
		<div class="promptInpt"><p class="promptTxt">重复密码</p></div>
		<input class="pwd02 inptText reg-repwd" name=""  type="password" />
	</div>
	<div>
		<div class="promptInpt"><p class="promptTxt">手机号</p></div>
		<input class="phone inptText reg-mobile" name="" type="text" />
	</div>
	<div>
		<div class="promptInpt"><p class="promptTxt">QQ号</p></div>
		<input class="QQ inptText reg-qq" name="" type="text" />
	</div>
	<!-- <div>
	...
	<!-- <div class="fl" style=" *width:110px;">
		<div class="promptInpt" style=" width:60px;"><p class="promptTxt" style=" width:60px; left:-16px; ">验证码</p></div>
		<input class="verification-code inptText reg-code" name="" type="text" />
	</div>
	<a class="verification-code-img fl" href="Javascript: void(0)" onclick="javascript:$(this).find('img').attr('src', '/Verify/' + Math.random())"><img src="/Verify" /></a> -->
	...
	<input class="btn-success bntH40" id="btn-regist" name="" type="button" value="注　册" />
</form>
<div class="stat" style=" width:240px; margin:0 auto;">
   		<!-- <input  class="fl" id="agree"   name="" type="checkbox" value="" checked="checked" /> -->
           <!-- <label  class="fl" for="agree" style=" color:#FFF; font-size:12px; font-family: '微软雅黑'">&nbsp;我同意</label>
   		<a class=" fl" style=" margin-left:5px; color:#0088cc; text-decoration:underline; font-size:12px;" href="/login/register_protocal" target="_blank">使用协议</a> -->
       	<a class=" fr" style="font-size:12px"  href="Javascript: void(0)" onclick="switching( '.register','.login')">返回登录</a>
...
<form class="fc" id="find-password-form">
	<div>
		<div class="promptInpt"><p class="promptTxt">用户名</p></div>
		<input class="user inptText find-password-email" name="" type="text" />
	</div>
	<!-- <div class="fl" style=" *width:110px;">
		<div class="promptInpt" style=" width:60px;"><p class="promptTxt" style=" width:60px; left:-16px; ">验证码</p></div>
		<input class="verification-code inptText find-password-code" name="" type="text" />
	</div>
	<a class="verification-code-img fl" href="Javascript: void(0)" onclick="javascript:$(this).find('img').attr('src', '/Verify/index/code_id/find_password/' + Math.random())"><img src="/Verify/index/code_id/find_password" /></a> -->
	...
	<input class="btn-success bntH40" id="btn-find-password" name="" type="button" value="找回密码" />
</form>
<div class="stat" style=" width:240px; margin:0 auto;">
       	<a class="" style="font-size:12px"  href="Javascript: void(0)" onclick="switching( '.find-password','.login')">返回登录</a>
...
<script src="${app}/Public/js/pages/login/login2.js?ver=2.3.1.1"></script>
</body>
</html>